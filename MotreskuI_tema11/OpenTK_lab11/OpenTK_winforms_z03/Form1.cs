...
using OpenTK_winforms_z02.SceneObjects;
using OpenTK_winforms_z03.SceneObjects.Scene;
...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private bool statusArc = true;
        private bool statusMyCube = true;
        private bool statusAnimation = false;
        private bool statusMyLight = false;
        private bool transparentArc = false;
        ...
        //# SET 1
        private float[] valuesAmbientTemplate0 = new float[] { 0.1f, 0.1f, 0.1f, 0.2f };
        ...
        public Form1() {
            //myCube = new Cube();
            myCube = new Cube(new Vector3(0, 20, 0), 20.0f, 4.0f);
            myLight = new Light(
                //new float[] { 0.2f, 0.2f, 0.2f, 1.0f },
                //new float[] { 1.0f, 1.0f, 1.0f, 1.0f },
                //new float[] { 0.1f, 0.2f, 1.0f, 0.1f },
                valuesAmbientTemplate0,
                valuesDiffuseTemplate0,
                valuesSpecularTemplate0,
                new float[] { 0.0f, 40.0f, 30.0f, 1.0f });
            ...
            animationTimer.Interval = 16; // Aproximativ 60 FPS (16 ms per frame)
        ...
        private void AnimationTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                float deltaTime = 0.016f; // 16 ms (aproximativ 60 FPS)
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            if(statusMyLight == true)
            {
                ...
                myLight.DrawLightSourceMarker();
                myLight.ApplyLight(LightName.Light3);
            }
        ...
        private void Load_Arc_Click(object sender, EventArgs e)
        {
            statusArc = !statusArc;
            GlControl1.Invalidate();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            myCube.setRotate(statusAnimation);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            transparentArc = !transparentArc;
            GlControl1.Invalidate();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            statusMyLight = !statusMyLight;
            if(statusMyLight) 
                myLight.Enable();
            else
                myLight.Disable();
        ...
        private void DeseneazaSemiSfera()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            {
                case 0:
                    currentColor = Color.White;      //Culoarea albă permite maparea texturii fără alterarea culorii originale.
                    break;
                case 1:
                    currentColor = Color.FromArgb(0, 255, 0, 0);
                    break;
                case 2:
                    currentColor = Color.FromArgb(0, 0, 0, 255);
                    break;
            }

            if (transparentArc == true)
            {
                GL.Enable(EnableCap.Blend);
                GL.BlendFunc(BlendingFactorSrc.SrcAlpha, BlendingFactorDest.OneMinusSrcAlpha);
                currentColor = new Color4(currentColor.R, currentColor.G, currentColor.B, 0.5f);
            }
            ...
            float height_arc = 2;
            float scale = 4.0f; // Variabilă pentru controlul mărimii


            GL.TexCoord2(0.0, 0.0);
            GL.Vertex3(-2 * scale, 0 * scale, 5 * scale);
            GL.TexCoord2(0.0, 1.0);
            GL.Vertex3(-2 * scale, 0 * scale, -5 * scale);
            GL.TexCoord2(0.25, 1.0);
            GL.Vertex3(0 * scale, 6 * scale, -5 * scale);
            GL.TexCoord2(0.25, 0.0);
            GL.Vertex3(0 * scale, 6 * scale, 5 * scale);
            ...
            GL.TexCoord2(0.25, 1.0);
            GL.Vertex3(0 * scale, 6 * scale, -5 * scale);
            GL.TexCoord2(0.4, 1.0);
            GL.Vertex3(2 * scale, 10 * scale, -5 * scale);
            GL.TexCoord2(0.4, 0.0);
            GL.Vertex3(2 * scale, 10 * scale, 5 * scale);
            ...
            GL.TexCoord2(0.4, 1.0);
            GL.Vertex3(2 * scale, 10 * scale, -5 * scale);
            GL.TexCoord2(0.475, 1.0);
            GL.Vertex3(4 * scale, 12 * scale, -5 * scale);
            GL.TexCoord2(0.475, 0.0);
            GL.Vertex3(4 * scale, 12 * scale, 5 * scale);
            ...
            GL.TexCoord2(0.475, 1.0);
            GL.Vertex3(4 * scale, 12 * scale, -5 * scale);
            GL.TexCoord2(0.525, 1.0);
            GL.Vertex3(5 * scale, 12 * scale, -5 * scale);
            GL.TexCoord2(0.525, 0.0);
            GL.Vertex3(5 * scale, 12 * scale, 5 * scale);
            ...
            GL.TexCoord2(0.525, 1.0);
            GL.Vertex3(5 * scale, 12 * scale, -5 * scale);
            GL.TexCoord2(0.6, 1.0);
            GL.Vertex3(7 * scale, 10 * scale, -5 * scale);
            GL.TexCoord2(0.6, 0.0);
            GL.Vertex3(7 * scale, 10 * scale, 5 * scale);
            ...
            GL.TexCoord2(0.6, 1.0);
            GL.Vertex3(7 * scale, 10 * scale, -5 * scale);
            GL.TexCoord2(0.75, 1.0);
            GL.Vertex3(9 * scale, 6 * scale, -5 * scale);
            GL.TexCoord2(0.75, 0.0);
            GL.Vertex3(9 * scale, 6 * scale, 5 * scale);
            ...
            GL.Vertex3(9 * scale, 6 * scale, -5 * scale);
            GL.TexCoord2(1.0, 1.0);
            GL.Vertex3(11 * scale, 0 * scale, -5 * scale);
            GL.TexCoord2(1.0, 0.0);
            GL.Vertex3(11 * scale, 0 * scale, 5 * scale);
        ...
        private void DeseneazaCubT_Tex3() {
            ...
            //GL.Normal3(0.0, 0.0, 1.0);
            GL.Begin(PrimitiveType.Triangles);
            for (int i = 0; i < nTrianglesList; i = i + 2) {
                //Atenție la modul de specificare a coordonatelor texturilor vis-a-vis de lista de vertexuri de intrare!
