    ...
    public class Camera : SceneObject<Camera>
    {
        ...
        public Camera(string fileName)
        {
            try
            {
                ...
                //Console.WriteLine(desearializedCamera.eyeY);
        ...
        public Matrix4 GetLookAt()
        {
            ...
            if (!afarLook)
                ...
                look = 10;
            return Matrix4.LookAt(eyeX*look, eyeY*look, eyeZ*look, targetX, targetY, targetZ, upX, upY, upZ);
        }
